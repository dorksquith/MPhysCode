Data<-read.csv("/Users/AliceWork/Documents/Dissertation/ProbSet3.csv", header=T)
SortedData1 <- read.csv("/Users/AliceWork/Documents/Dissertation/SortedProbSet3.csv", header=T)
...
#hist(SortedData1$ProbH, breaks=50, xlim=c(0,1), ylim=c(0,1300), col="red", main="Probability of correct H Classification (100,000)", xlab="Probability of correct H Classification")
