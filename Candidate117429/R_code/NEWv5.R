Data<-read.csv("/Users/AliceWork/Documents/Dissertation/ProbSet5.csv", header=T)
SortedData1 <- read.csv("/Users/AliceWork/Documents/Dissertation/SortedProbSet5.csv", header=T)
