Data<-read.csv("/Users/AliceWork/Documents/Dissertation/ProbSet2.csv", header=T)
SortedData1 <- read.csv("/Users/AliceWork/Documents/Dissertation/SortedProbSet2.csv", header=T)
