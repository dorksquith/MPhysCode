...
#a = scipy.delete(a, 9, 1)
#Additional column deletes to change desired input variables
a = scipy.delete(a, 12, 1)
a = scipy.delete(a, 11, 1)
a = scipy.delete(a, 10, 1)
a = scipy.delete(a, 9, 1)
a = scipy.delete(a, 7, 1)
a = scipy.delete(a, 4, 1)
a = scipy.delete(a, 3, 1)
...
#b = scipy.delete(b, 9, 1)
#Additional column deletes to change desired input variables
b = scipy.delete(b, 12, 1)
b = scipy.delete(b, 11, 1)
b = scipy.delete(b, 10, 1)
b = scipy.delete(b, 9, 1)
b = scipy.delete(b, 7, 1)
b = scipy.delete(b, 4, 1)
b = scipy.delete(b, 3, 1)
b = scipy.delete(b, 1, 1)
...
Y_train = Data[:,5][r<cutoff]
X_train = Data[:,0:4][r<cutoff]

Y_test = Data[:,5][r>=cutoff]
X_test = Data[:,0:4][r>=cutoff]


#clf = GradientBoostingClassifier(n_estimators=100, max_depth=1, random_state=0).fit(X_train, Y_train)
clf = GradientBoostingClassifier(n_estimators=50 , max_depth = 5, min_samples_leaf=200,max_features=3,verbose=1)
...
HZ1=np.zeros((len(PredictProb), 2))
#Prob of higgs only
