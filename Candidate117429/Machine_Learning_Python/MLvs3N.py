#All Variables except rap phi & MM
...
Y_train = Data[:,8][r<cutoff]
X_train = Data[:,0:7][r<cutoff]

Y_test = Data[:,8][r>=cutoff]
X_test = Data[:,0:7][r>=cutoff]


#clf = GradientBoostingClassifier(n_estimators=100, max_depth=1, random_state=0).fit(X_train, Y_train)
clf = GradientBoostingClassifier(n_estimators=50 , max_depth = 5, min_samples_leaf=200,max_features=5,verbose=1)
